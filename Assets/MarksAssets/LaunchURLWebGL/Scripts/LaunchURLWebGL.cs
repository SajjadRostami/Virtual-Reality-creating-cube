...
namespace MarksAssets.LaunchURLWebGL {
	...
	public class LaunchURLWebGL:MonoBehaviour {
		...
		public static extern void launchURL(string url = "https://stackoverflow.com/questions/27339059/little-script-for-unity3d-to-open-url-in-a-default-external-browser", string windowName = "_blank", string windowFeatures = "");

...
namespace IBM.Watson.Assistant.V1
{
    public partial class AssistantService : BaseService
    {
        ...
        public bool Message(Callback<MessageResponse> callback, string workspaceId, MessageInput input = null, List<RuntimeIntent> intents = null, List<RuntimeEntity> entities = null, bool? alternateIntents = null, Context context = null, OutputData output = null, bool? nodesVisitedDetails = null, string assistantId = null, string sessionId = null)
        {
            if (callback == null)
        ...
        public object Message(string assistantId, string sessionId, MessageInput input)
        {

...
namespace IBM.Watson.Examples
{
    public class ExampleAssistantV1 : MonoBehaviour
    {
        ...
        private IEnumerator CreateService()
        {
            ...
            IamAuthenticator authenticator = new IamAuthenticator(apikey: "rCqOHa0KGiQJH0w9sGSt5EWi38ly-iyt9Q_rSHyvgGmm");

            //  Wait for tokendata
            while (!authenticator.CanAuthenticate())
                yield return null;

            service = new AssistantService("2021-05-30", authenticator);
            service.SetServiceUrl("https://api.us-south.assistant.watson.cloud.ibm.com/instances/1fad6f38-1bc4-42c3-b159-1176e7e442d5/v2/assistants/29bc4d88-0fdb-4fac-b9f7-efea3a00ff50/sessions");

            workspaceId = Environment.GetEnvironmentVariable("8eb0a0b9-3329-417c-a10c-410f936c6551");
